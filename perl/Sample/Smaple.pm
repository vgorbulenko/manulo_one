...
use Exporter;
our @ISA = qw(Exporter); #какой то системный, связан с облостью вилимости, перечисляем имена предков, классов родителей
#сделали exportet родителем текущего класса. Массив, в котором перечисляются родители текущего класса
